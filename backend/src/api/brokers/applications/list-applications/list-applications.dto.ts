...
export class BrokerApplicationPostResponseDto extends SuccessResponseDto {
  @ApiProperty({ description: 'Indicates if the loan amount is above or below the average.' })
  readonly message: string;

  @ApiProperty({ description: 'The average loan amount of all applications.' })
  readonly averageLoanAmount: number;

  @ApiProperty({ description: 'The loan amount of the newly created application.' })
  readonly loanAmount: number;

  @ApiProperty({ description: 'The ID of the created application.' })
